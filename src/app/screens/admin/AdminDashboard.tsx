      ...
      <div className="bg-white border-b border-gray-200 px-5 xl:px-8 py-3.5 sticky top-0 z-10">
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-2">
            ...
            <h1 className="hidden xl:block text-xl font-bold text-gray-900">Dashboard</h1>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => { logout(); navigate("/login"); }}
              className="xl:hidden flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-red-500 bg-red-50 hover:bg-red-100 rounded-xl border border-red-100 transition-colors">
