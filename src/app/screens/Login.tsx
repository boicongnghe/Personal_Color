      ...
      <div className="px-6">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 gap-3 mt-6">
            <button className="flex items-center justify-center gap-2 py-3 px-4 bg-white border-2 border-purple-100 rounded-2xl hover:bg-purple-50 transition-colors shadow-sm">
